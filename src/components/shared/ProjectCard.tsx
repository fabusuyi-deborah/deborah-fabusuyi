    ...
    >
      ...
      <div className="text-white w-full lg:w-2/5 space-y-4 mt-4 sm:mt-12 ">
        ...
        <div className="flex items-center gap-4">
          <Link href={project.githubLink} target="_blank" className="flex items-center gap-1 border border-white px-3 py-1 rounded-full">
            <Github size={16} /> Code
          </Link>

          <Link href={project.liveLink} target="_blank" className="flex items-center gap-1 border border-white px-3 py-1 rounded-full">
